...
class MusicianPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // التبويبات الداخلية: 0=الرئيسية (المنشورات), 1=الفعاليات
    final pages = <Widget>[
      const PostsFeed(), // خلاصة كل المنشورات
      const _MusicianEventsTab()
    ];
    ...
    final items = <NavItemData>[
      const NavItemData(
        ...
        label: 'الملف',
        onTapRoute: '/musicianProfile',
      ),
      const NavItemData(
        icon: Icons.calendar_month_rounded,
        label: 'الحجوزات',
        onTapRoute: '/musicianBookings',
      ),
      const NavItemData(
      ...
      const NavItemData(
        ...
        label: 'الفعاليات',
        pageIndex: 1, // يبدّل للتبويب الداخلي (فعاليات)
      ),
      const NavItemData(
...
class _MusicianEventsTab extends StatefulWidget {
  const _MusicianEventsTab();
  @override
  State<_MusicianEventsTab> createState() => _MusicianEventsTabState();
}

class _MusicianEventsTabState extends State<_MusicianEventsTab> {
